...
@interface DebugSessionManager ()<NSURLSessionDelegate>
...
@implementation DebugSessionManager

+ (instancetype)sharedManager{
    static DebugSessionManager *manager = nil;
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.lock.name = @"com.PerfectDebug.DebugSessionManager.session.name";
