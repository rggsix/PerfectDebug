...
@interface DebugAppHardwareMonitor ()
...
@implementation DebugAppHardwareMonitor

+ (instancetype)shared {
    static DebugAppHardwareMonitor *ins;
...
+ (void)startMonitorWithCallback:(DebugAppHardwareMonitorCallback)callback {
    [DebugAppHardwareMonitor.shared startMonitorWithCallback:callback];
}

+ (void)pauseMonitor {
    [DebugAppHardwareMonitor.shared pauseMonitor];
}

+ (uint)fps {
    return DebugAppHardwareMonitor.shared.fps;
}

+ (uint)cpu {
    return DebugAppHardwareMonitor.shared.cpu;
}

+ (uint)mem {
    return DebugAppHardwareMonitor.shared.mem;
}
