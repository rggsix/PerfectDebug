...
kISFullScreen = [[UIApplication sharedApplication] delegate].window.safeAreaInsets.bottom > 0.0;\
}\
(kISFullScreen);})
...
if (@available(iOS 11.0, *)) {\
kSafeAreaTop = [[UIApplication sharedApplication] delegate].window.safeAreaInsets.top;\
}\
(kSafeAreaTop);})
