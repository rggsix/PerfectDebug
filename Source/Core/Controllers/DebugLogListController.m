...
#import "DebugTagListSelectController.h"
...
@interface DebugLogListController ()<UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate>
...
@implementation DebugLogListController

- (instancetype)initWithOnceStart:(DebugOnceStart *)onceStart{
    if (self = [super init]) {
        ...
        self.dataSource = [[DebugLogDataSource alloc] initWithLogs:onceStart.originLogs];
...
- (void)loadView{
    ...
    [self.tableView registerClass:[DebugLogAbstractCell class] forCellReuseIdentifier:kDebugDisplayCellID];
...
- (void)searchWithText:(NSString *)searchText {
    ...
    DebugLogSearchListController *searchVC = [[DebugLogSearchListController alloc] initWithDataSource:self.dataSource];
...
- (void)navByTagClicked{
    ...
    DebugTagListSelectController *tagVC = [[DebugTagListSelectController alloc] initWithTags:self.dataSource.tags callback:^(NSString * _Nonnull tag) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    DebugLogAbstractCell *cell = [self.tableView dequeueReusableCellWithIdentifier:kDebugDisplayCellID forIndexPath:indexPath];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DebugLogInfoController *logInfoVC = [[DebugLogInfoController alloc] initWithLogModel:self.dataSource.logs[indexPath.row]];
