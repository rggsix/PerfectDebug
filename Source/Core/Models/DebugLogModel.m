...
- (NSString *)abstractString {
    if (!_abstractString) {
        DebugLogAbstractProvider provider = [PerfectDebug.shared getAbstractProviderForTag:_tag];
