...
@interface DebugLogAbstractCell()
...
@implementation DebugLogAbstractCell
...
- (void)setLogModel:(DebugLogModel *)logModel{
    _logModel = logModel;
    ...
    if ([logModel isKindOfClass:[DebugLogSearchResult class]]) {
        self.dg_contentLabel.attributedText = [(DebugLogSearchResult *)logModel searchAttrStr];
    } else {
